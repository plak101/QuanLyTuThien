...
import charity.controller.UserController.EventPanelController;
...
//    private 
    ...
    public EventPanel(JFrame parent, int accountId, int userId) {
...
//        header.changeColor("#abc6e5", "#86fde8");
        ...
        init();
        controller = new EventPanelController(parent, accountId, userId, txtSearch, jrbtId, jrbtName, jrbtCategory, gbtReset, gbtDonate, jbtActive, jbtExpired, table);
    ...
    public EventPanelController getController() {
        return controller;
    }
